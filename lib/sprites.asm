...
sprite_definitions: 
	...
	.byte SPRITE_TYPE_INVULN_ENEMY, 16, 16, SPRITE_SIZE_DEFAULT, SPRITE_ANIMATION_NORMAL, $40, PALETTE_1, 1	; 4. Militarized turtle
...
; Dimension Swappers
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, SPRITE_ANIMATION_NONE, $cf, DIMENSION_PLAIN, DIMENSION_CALM
