...
sprite_definitions: 
	...
	.byte SPRITE_TYPE_SHARK, 16, 8, SPRITE_SIZE_2X1, SPRITE_ANIMATION_LR, $80, PALETTE_1, 0 ; Blank sprites to keep dimension stuff on one line.

; Dimension Swappers
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_PLAIN, $cf, PALETTE_0, DIMENSION_BARREN
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_PLAIN, $cf, PALETTE_0, DIMENSION_ICE_AGE
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_BARREN, $cf, PALETTE_0, DIMENSION_ICE_AGE
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_AGGRESSIVE, $cf, PALETTE_0, DIMENSION_PLAIN
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_AGGRESSIVE, $cf, PALETTE_0, DIMENSION_ICE_AGE
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_BARREN, $cf, PALETTE_0, DIMENSION_AGGRESSIVE
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_AGGRESSIVE, $cf, PALETTE_0, DIMENSION_END_OF_DAYS
	.byte SPRITE_TYPE_DIMENSIONER, 32, 16, SPRITE_SIZE_TINY_NORMAL_ALIGNMENT, DIMENSION_PLAIN, $cf, PALETTE_0, DIMENSION_END_OF_DAYS
	...
	.byte SPRITE_TYPE_TELEPORT, 24, 8, SPRITE_SIZE_TELEPORTER, SPRITE_ANIMATION_BINARY, $48, PALETTE_2, DIMENSION_PLAIN
	.byte SPRITE_TYPE_TELEPORT, 24, 8, SPRITE_SIZE_TELEPORTER, SPRITE_ANIMATION_BINARY, $48, PALETTE_2, DIMENSION_END_OF_DAYS ; Intentional duplicate... based on id, first one only shows in normal dim, second only in dark.